...
export const caseStudies = [
  {
    ...
    title:
      "Kinetix: An AI Marketing Engine That Builds Ads, Tests Them, and Moves the Budget Itself",
    client: "Case Study",
    industry: "Case Study",
    date: "August 28, 2026",
    tags: ["Case Study"],
...

  {
    ...
    sections: [
      ...
      },
      {
        type: "content",
        content:
          "In practice it is almost invisible. A customer messages the business number the way they always have. Compass recognises whether they are new or returning, pulls up their history, checks the live catalog and the business's own policies, and replies in the brand's voice, usually before the customer has put their phone down. The exchange is logged instantly, so the team can open the dashboard at any point and see who is talking, what they want, what was promised, and what it cost to handle. Nothing needs to be reconstructed later. The owner's job shifts from answering the same questions all day to reviewing what the questions are telling them.",
